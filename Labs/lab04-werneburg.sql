...
select orderid, orderdate, custid, empid from sales.orders where orderdate = 
...
SELECT  top (1) with ties o1.custid, count(o1.orderid) from sales.orders o1 group by o1.custid 
  order by count(orderid) desc;
SELECT o1.custid from sales.orders o1;

SELECT o.orderid, o.custid, o.empid, o.orderdate
 from sales.orders o where o.custid IN (SELECT  top (1) o1.custid from sales.orders o1 group by o1.custid 
  order by count(orderid) desc);
...
select e.empid, e.firstname, e.lastname from hr.employees e where e.empid NOT IN (select distinct o.empid from sales.orders o where o.orderdate >= '2016-05-01');
